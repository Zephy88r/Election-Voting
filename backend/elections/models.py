...
class FPTPVote(models.Model):
    ...
    def __str__(self):
        return f"{self.voter} - FPTP({self.candidate})"
...
class PRVote(models.Model):
    ...
    def __str__(self):
        return f"{self.voter} - PR({self.party})"


# ==============================
# Vote (Legacy/Combined - kept for compatibility)
# ==============================
class Vote(models.Model):
    ...
    class Meta:
        verbose_name = "Vote (Legacy)"
        verbose_name_plural = "Votes (Legacy)"
